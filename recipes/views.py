...
def searchinput_view(request):
    ...
    ''' 
    # Below is some setup
    url1 = "https://djangojoy.blogspot.com/feeds/posts/default?start-index=1&max-results=150"
    url2 = "https://djangojoy.blogspot.com/feeds/posts/default?start-index=151&max-results=150"
    url3 = "https://djangojoy.blogspot.com/feeds/posts/default?start-index=301&max-results=150"
    url4 = "https://djangojoy.blogspot.com/feeds/posts/default?start-index=451&max-results=150"
